...
export type GetCommentLikeAggregateType<T extends CommentLikeAggregateArgs> = {
    [P in keyof T & keyof AggregateCommentLike]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateCommentLike[P]> : Prisma.GetScalarType<T[P], AggregateCommentLike[P]>;
};
...
export type GetCommentLikeGroupByPayload<T extends CommentLikeGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<CommentLikeGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof CommentLikeGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], CommentLikeGroupByOutputType[P]> : Prisma.GetScalarType<T[P], CommentLikeGroupByOutputType[P]>;
}>>;
export type CommentLikeWhereInput = {
    ...
    comment?: Prisma.XOR<Prisma.ReviewCommentScalarRelationFilter, Prisma.ReviewCommentWhereInput>;
};
export type CommentLikeOrderByWithRelationInput = {
    ...
    comment?: Prisma.ReviewCommentOrderByWithRelationInput;
};
...
export type CommentLikeCreateInput = {
    ...
    comment: Prisma.ReviewCommentCreateNestedOneWithoutLikesInput;
};
...
export type CommentLikeUpdateInput = {
    ...
    comment?: Prisma.ReviewCommentUpdateOneRequiredWithoutLikesNestedInput;
};
...
export type CommentLikeSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
    ...
    comment?: boolean | Prisma.ReviewCommentDefaultArgs<ExtArgs>;
...
export type $CommentLikePayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    ...
    objects: {
        ...
        comment: Prisma.$ReviewCommentPayload<ExtArgs>;
    };
...
export type CommentLikeCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<CommentLikeFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface CommentLikeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends CommentLikeCountArgs>(args?: Prisma.Subset<T, CommentLikeCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], CommentLikeCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends CommentLikeGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, CommentLikeGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCommentLikeGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface Prisma__CommentLikeClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    comment<T extends Prisma.ReviewCommentDefaultArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.ReviewCommentDefaultArgs<ExtArgs>>): Prisma.Prisma__ReviewCommentClient<runtime.Types.Result.GetResult<Prisma.$ReviewCommentPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | Null, Null, ExtArgs, GlobalOmitOptions>;
    /**
...
//# sourceMappingURL=CommentLike.d.ts.map