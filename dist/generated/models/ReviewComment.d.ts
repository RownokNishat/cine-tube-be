...
export type GetReviewCommentAggregateType<T extends ReviewCommentAggregateArgs> = {
    [P in keyof T & keyof AggregateReviewComment]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateReviewComment[P]> : Prisma.GetScalarType<T[P], AggregateReviewComment[P]>;
};
...
export type GetReviewCommentGroupByPayload<T extends ReviewCommentGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ReviewCommentGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ReviewCommentGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ReviewCommentGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ReviewCommentGroupByOutputType[P]>;
}>>;
...
export type ReviewCommentScalarRelationFilter = {
    is?: Prisma.ReviewCommentWhereInput;
    isNot?: Prisma.ReviewCommentWhereInput;
};
...
export type ReviewCommentCreateNestedOneWithoutLikesInput = {
    create?: Prisma.XOR<Prisma.ReviewCommentCreateWithoutLikesInput, Prisma.ReviewCommentUncheckedCreateWithoutLikesInput>;
    connectOrCreate?: Prisma.ReviewCommentCreateOrConnectWithoutLikesInput;
    connect?: Prisma.ReviewCommentWhereUniqueInput;
};
export type ReviewCommentUpdateOneRequiredWithoutLikesNestedInput = {
    create?: Prisma.XOR<Prisma.ReviewCommentCreateWithoutLikesInput, Prisma.ReviewCommentUncheckedCreateWithoutLikesInput>;
    connectOrCreate?: Prisma.ReviewCommentCreateOrConnectWithoutLikesInput;
    upsert?: Prisma.ReviewCommentUpsertWithoutLikesInput;
    connect?: Prisma.ReviewCommentWhereUniqueInput;
    update?: Prisma.XOR<Prisma.XOR<Prisma.ReviewCommentUpdateToOneWithWhereWithoutLikesInput, Prisma.ReviewCommentUpdateWithoutLikesInput>, Prisma.ReviewCommentUncheckedUpdateWithoutLikesInput>;
};
...
export type ReviewCommentUncheckedCreateWithoutLikesInput = {
    id?: string;
    userId: string;
    reviewId: string;
    content: string;
...
export type ReviewCommentCreateOrConnectWithoutLikesInput = {
    where: Prisma.ReviewCommentWhereUniqueInput;
    create: Prisma.XOR<Prisma.ReviewCommentCreateWithoutLikesInput, Prisma.ReviewCommentUncheckedCreateWithoutLikesInput>;
};
export type ReviewCommentUpsertWithoutLikesInput = {
    update: Prisma.XOR<Prisma.ReviewCommentUpdateWithoutLikesInput, Prisma.ReviewCommentUncheckedUpdateWithoutLikesInput>;
    create: Prisma.XOR<Prisma.ReviewCommentCreateWithoutLikesInput, Prisma.ReviewCommentUncheckedCreateWithoutLikesInput>;
    where?: Prisma.ReviewCommentWhereInput;
};
export type ReviewCommentUpdateToOneWithWhereWithoutLikesInput = {
    where?: Prisma.ReviewCommentWhereInput;
    data: Prisma.XOR<Prisma.ReviewCommentUpdateWithoutLikesInput, Prisma.ReviewCommentUncheckedUpdateWithoutLikesInput>;
};
...
export type ReviewCommentUncheckedUpdateWithoutLikesInput = {
    id?: Prisma.StringFieldUpdateOperationsInput | string;
    userId?: Prisma.StringFieldUpdateOperationsInput | string;
    reviewId?: Prisma.StringFieldUpdateOperationsInput | string;
    content?: Prisma.StringFieldUpdateOperationsInput | string;
...
export type ReviewCommentCountOutputTypeSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    ...
    likes?: boolean | ReviewCommentCountOutputTypeCountLikesArgs;
};
/**
 ...
 * ReviewCommentCountOutputType without action
 */
export type ReviewCommentCountOutputTypeCountLikesArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
...
export type ReviewCommentSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
    ...
    likes?: boolean | Prisma.ReviewComment$likesArgs<ExtArgs>;
...
export type ReviewCommentCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ReviewCommentFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ReviewCommentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['ReviewComment'];
        meta: {
            name: 'ReviewComment';
        };
    };
     ...
     * })
    **/
    count<T extends ReviewCommentCountArgs>(args?: Prisma.Subset<T, ReviewCommentCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ReviewCommentCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ReviewCommentGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ReviewCommentGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetReviewCommentGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface Prisma__ReviewCommentClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    likes<T extends Prisma.ReviewComment$likesArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.ReviewComment$likesArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$CommentLikePayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>;
    /**
 ...
 * ReviewComment.likes
 */
export type ReviewComment$likesArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
