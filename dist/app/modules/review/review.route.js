...
router.get("/me", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.getMyReviews);
// GET /api/v1/reviews/:reviewId/permissions - get current user's review action permissions
router.get("/:reviewId/permissions", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.getReviewPermissions);
// GET /api/v1/reviews/:reviewId - get single review
router.get("/:reviewId", ReviewController.getReviewById);
// PATCH /api/v1/reviews/:reviewId - update own review (unpublished only)
router.patch("/:reviewId", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), validateRequest(updateReviewSchema), ReviewController.updateReview);
// DELETE /api/v1/reviews/:reviewId - delete own review
router.delete("/:reviewId", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.deleteReview);
// ==================== REVIEW LIKES ====================
// POST /api/v1/reviews/:reviewId/like - like a review
router.post("/:reviewId/like", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.likeReview);
// DELETE /api/v1/reviews/:reviewId/like - unlike a review
router.delete("/:reviewId/like", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.unlikeReview);
// ==================== REVIEW COMMENTS ====================
...
router.post("/:reviewId/comments", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), validateRequest(addCommentSchema), ReviewController.addComment);
// PATCH /api/v1/comments/:commentId - update own comment
router.patch("/comments/:commentId", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), validateRequest(updateCommentSchema), ReviewController.updateComment);
// DELETE /api/v1/comments/:commentId - delete own comment
router.delete("/comments/:commentId", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.deleteComment);
// ==================== COMMENT REPLIES ====================
// POST /api/v1/comments/:commentId/replies - reply to a comment
router.post("/comments/:commentId/replies", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), validateRequest(addCommentSchema), ReviewController.replyToComment);
// ==================== COMMENT LIKES ====================
// POST /api/v1/comments/:commentId/like - like a comment
router.post("/comments/:commentId/like", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.likeComment);
// DELETE /api/v1/comments/:commentId/like - unlike a comment
router.delete("/comments/:commentId/like", checkAuth(Role.USER, Role.ADMIN, Role.SUPER_ADMIN), ReviewController.unlikeComment);
// ==================== ADMIN ROUTES ====================
// PATCH /api/v1/reviews/:reviewId/approve - approve pending review
router.patch("/:reviewId/approve", checkAuth(Role.ADMIN, Role.SUPER_ADMIN), ReviewController.approveReview);
// PATCH /api/v1/reviews/:reviewId/unpublish - unpublish review
router.patch("/:reviewId/unpublish", checkAuth(Role.ADMIN, Role.SUPER_ADMIN), ReviewController.unpublishReview);
// PATCH /api/v1/reviews/:reviewId/reject - reject pending review (alias to unpublish)
router.patch("/:reviewId/reject", checkAuth(Role.ADMIN, Role.SUPER_ADMIN), ReviewController.rejectReview);
