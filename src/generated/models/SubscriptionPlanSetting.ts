...
// @ts-nocheck 
/*
 * This file exports the `SubscriptionPlanSetting` model and its related types.
 *
...
export type GetSubscriptionPlanSettingAggregateType<T extends SubscriptionPlanSettingAggregateArgs> = {
      [P in keyof T & keyof AggregateSubscriptionPlanSetting]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSubscriptionPlanSetting[P]>
    : Prisma.GetScalarType<T[P], AggregateSubscriptionPlanSetting[P]>
}
...
export type GetSubscriptionPlanSettingGroupByPayload<T extends SubscriptionPlanSettingGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SubscriptionPlanSettingGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SubscriptionPlanSettingGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SubscriptionPlanSettingGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SubscriptionPlanSettingGroupByOutputType[P]>
      }
    >
  >
...
export type SubscriptionPlanSettingCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SubscriptionPlanSettingFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SubscriptionPlanSettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SubscriptionPlanSetting'], meta: { name: 'SubscriptionPlanSetting' } }
  /**
   ...
   * })
  **/
  count<T extends SubscriptionPlanSettingCountArgs>(
    args?: Prisma.Subset<T, SubscriptionPlanSettingCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SubscriptionPlanSettingCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SubscriptionPlanSettingGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SubscriptionPlanSettingGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSubscriptionPlanSettingGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
